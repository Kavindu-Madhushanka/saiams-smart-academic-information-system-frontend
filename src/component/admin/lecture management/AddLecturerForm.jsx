  ...
  const handleSubmitL = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5104/api/Auth/addlectures",
        lectureFormData,
      );
      ...
      <div className="w-full max-w-2xl bg-white shadow-2xl rounded-2xl flex flex-col max-h-[90vh] overflow-hidden duration-300 animate-in fade-in zoom-in">
        ...
        >
            ...
            <div className="grid grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                ...
                <select
                  name="academicRole"
                  onChange={handleChangeL}
                  className="w-full px-4 py-2.5 bg-white border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 outline-none text-gray-900 transition-all"
                >
          ...
          <div className="flex justify-end flex-shrink-0 gap-3 p-6 border-t border-gray-100 bg-gray-50">
            ...
            <button
              type="submit"
              className="px-6 py-2.5 text-sm font-bold text-white bg-blue-600 rounded-lg hover:bg-blue-700 shadow-lg shadow-blue-500/30 transition-all"
            >
              Save Lecturer
            </button>
          </div>
